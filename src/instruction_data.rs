...
impl AddressingMode {
    pub fn get_addressing_mode(opcode: u8) -> Self {
        ...
        match opcode {
            ...
            0x02 | 0x12 | 0x70 | 0x72..=0x75 | 0x77 | 0xe2 => Memreg_Reg,
            0x03..=0x05
            | 0x0b..=0x0d
            | 0x13..=0x15
            | 0x1b..=0x1d
            ...
            | 0xf1
            | 0xf5 => Reg,
            0x06 | 0x16 | 0x1e | 0x26 | 0x2e | 0x3e | 0xc6 | 0xce | 0xde => Reg_d8,
            0x08 | 0xea => a16_Reg,
            0x09
            | 0x19
            | 0x29
            ...
            | 0x9f
            | 0xf9 => Reg_Reg,
            0x0a | 0x1a | 0x46 | 0x56 | 0x5e | 0x66 | 0x6e | 0x7e | 0x86 | 0x8e | 0x9e | 0xf2 => {
                Reg_Memreg
            }
            0x0e | 0x10 | 0xd6 | 0xe6 | 0xee | 0xf6 | 0xfe => d8,
            0x18 | 0x20 | 0x28 | 0x30 | 0x38 => r8,
            0x22 => HLI_Reg,
            0x2a => Reg_HLI,
            0x32 => HLD_Reg,
            0x34..=0x35 | 0x4e | 0x71 | 0x96 | 0xa6 | 0xae | 0xb6 | 0xbe => Memreg,
            0x36 => Memreg_d8,
            0x3a => Reg_HLD,
